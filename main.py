# Documentation for these tutorials can be found at:
# tinyurl.com/24fdrrv4
...
# about route
@app.route('/test')  # note the leading slash, it’s important
def test():
...
def all_pizzas():
    ...
    # it’s own function for easy re-use
    ...
    return render_template('all_pizzas.html', page_title='ALL PIZZAS', pizzas=pizzas)
